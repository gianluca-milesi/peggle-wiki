...
INSERT INTO `reviews` VALUES (1,1,'Alice','Bjorn Unicorn is awesome! Really helpful during the game, gives perfect ball predictions!',5),(2,2,'Bob','Jimmy Lightning is a fun character, but sometimes the balls become a bit too chaotic for my taste.',3),(3,3,'Charlie','Kat Tut adds an interesting twist with the pyramid, but I find it hard to control the ball.',4),(4,4,'David','Splork Sporkan is my favorite! The Space Blast power is amazing for clearing pegs.',5),(5,5,'Eva','Claude Lobster is fun, but the flippers power feels a bit repetitive.',3),(6,6,'Frank','Renfield Pumpkin is spooky! I love how the ball comes back, really adds a challenge.',4),(7,7,'Grace','Tula Sunflower is a great character! Flower Power is super helpful, especially on orange pegs.',5),(8,8,'Henry','Warren Rabbit’s Lucky Spin power is unpredictable, but I enjoy the variety it brings.',4),(9,9,'Ivy','Lord Cinderbottom is a powerhouse! The Fireball clears everything in its path.',5),(10,10,'Jack','Master Hu is a calming presence, Zen Ball improves my focus during gameplay.',4),(11,11,'Kim','Marina’s Electrobolt power is very useful, especially for clearing multiple pegs at once!',4),(32,1,'Alessandro','Un personaggio ben costruito con una storia interessante.',4),(33,2,'Francesca','Non mi ha convinto del tutto, ma ha del potenziale.',3),(34,3,'Giovanni','Un vero eroe! Lo adoro.',5),(35,4,'Martina','Un po’ troppo prevedibile nelle sue azioni.',2),(36,5,'Luca','Una caratterizzazione perfetta e poteri incredibili!',5),(37,6,'Bob','Mi aspettavo di più, sembra un personaggio secondario.',3),(38,7,'Simone','Ha un background molto affascinante.',4),(39,8,'Chiara','Non riesco a trovare difetti, è il mio preferito.',5),(40,9,'Davide','Troppo stereotipato, poco originale.',2),(41,10,'Sara','Ben scritto, ma manca qualcosa per renderlo speciale.',3),(42,11,'Riccardo','Merita sicuramente più spazio nella storia!',4),(43,1,'Laura','Una sorpresa inaspettata, mi ha stupito.',5),(44,3,'Giorgio','Potrebbe essere approfondito meglio.',3),(45,4,'Valentina','Uno dei migliori personaggi mai creati!',5),(46,6,'Federico','Molto carismatico e ben sviluppato.',4),(47,6,'Alice','La sua evoluzione nella storia è stupenda.',5),(48,1,'Marco','Non mi piace molto il suo atteggiamento.',2),(49,2,'Giulia','Semplicemente fantastico, il mio preferito!',5),(50,2,'Andrea','Mi ha emozionato più di quanto pensassi.',4),(51,2,'Sofia','Ha una personalità unica e intrigante.',5);
...
-- Dump completed on 2025-02-11 14:42:52
